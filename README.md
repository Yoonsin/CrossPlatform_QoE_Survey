...
- 시나리오 2: 알고리즘 1,2 적용 전, 알고리즘 1 적용 후, 알고리즘 2 적용 후
- 시나리오 3: 알고리즘 2 적용 전, 알고리즘 2 적용 후

| 타임스탬프 | 참가자 ID | 생년 | 성별 | 알고리즘 | 설문 번호 | 시나리오 | 단계 | Q1 | Q2 | Q3 | Q4 | Q2 추가 - 환경 격차 | Q2 추가 - 기타 | 자유 의견 |
|-----------|----------|------|------|----------|-----------|----------|------|----|----|----|----|-------------------|---------------|-----------|
| 2026-04-15T... | P001 | 2000 | 여성 | 알고리즘 1 | 1 | 1 | 적용 전 | 3 | 4 | 2 | 4 | 플랫폼 | | 의견 |
